...
const BottomNav: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-4 left-4 right-4 z-50">
            <div className="flex items-center justify-between gap-1.5 rounded-full bg-tg-secondary/95 p-1.5 shadow-xl backdrop-blur-md border border-tg-hint/10">
                {tabs.map((tab) => {
                    ...
                    return (
                        <motion.button
                            ...
                            className={cn(
                                "relative flex flex-1 items-center justify-center gap-1.5 rounded-full py-2.5 px-2 overflow-hidden min-w-0",
