...
const SupportModal: React.FC<SupportModalProps> = ({ isOpen, onClose, supportInfo }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="bg-tg-bg w-full max-w-md rounded-2xl overflow-hidden shadow-2xl animate-slide-up">
                {/* Header */}
                <div className="p-4 border-b border-tg-secondary flex justify-between items-center bg-tg-secondary/30">
