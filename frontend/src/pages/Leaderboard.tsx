...
const Leaderboard: React.FC = () => {
    ...
    const mockLeaderboard = [
        { rank: 1, users: { first_name: 'Alisher Navoiy' }, score: 2850 },
        { rank: 2, users: { first_name: 'Emma Watson' }, score: 2720 },
        { rank: 3, users: { first_name: 'Jasur Khakimov' }, score: 2680 },
        { rank: 4, users: { first_name: 'Sofia Rodriguez' }, score: 2550 },
        { rank: 5, users: { first_name: 'Akmal Yusupov' }, score: 2480 },
        { rank: 6, users: { first_name: 'Olivia Chen' }, score: 2420 },
        { rank: 7, users: { first_name: 'Rustam Azimov' }, score: 2350 },
        { rank: 8, users: { first_name: 'Liam O\'Brien' }, score: 2290 },
        { rank: 9, users: { first_name: 'Madina Sharipova' }, score: 2220 },
        { rank: 10, users: { first_name: 'Noah Anderson' }, score: 2150 },
        { rank: 11, users: { first_name: 'Dilnoza Karimova' }, score: 2080 },
        { rank: 12, users: { first_name: 'Arjun Patel' }, score: 2010 },
        { rank: 13, users: { first_name: 'Isabella Garcia' }, score: 1940 },
        { rank: 14, users: { first_name: 'Bekzod Tursunov' }, score: 1870 },
        { rank: 15, users: { first_name: 'Yuki Tanaka' }, score: 1800 },
        { rank: 16, users: { first_name: 'Sevara Abdullayeva' }, score: 1730 },
        { rank: 17, users: { first_name: 'Mohammed Ali' }, score: 1660 },
        { rank: 18, users: { first_name: 'Anastasia Petrova' }, score: 1590 },
        { rank: 19, users: { first_name: 'Shohruh Rahimov' }, score: 1520 },
        { rank: 20, users: { first_name: 'Aisha Hassan' }, score: 1450 },
    ];
